...
class InformationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final docStream =
    FirebaseFirestore.instance.collection('informations').doc('Mentions Légalesid prospecto').snapshots();

    return Theme(
      data: theme,
      child: Scaffold(
        appBar: AppBar(
          title           : const Text('Consultez nos mentions légales'),
