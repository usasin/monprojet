...
class _ReportingPageState extends State<ReportingPage> {
  ...
  Future<void> _onSave() async {
    ...
    // nettoie la clé locale 'closed'
    final cleanReports = {
      for (var e in _reports.entries) e.key: {...e.value..remove('closed')}
    };
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Padding(
          ...
          child: Text('Prospections du {date} enregistrées.'
              .tr(namedArgs: {'date': DateFormat.yMd().format(_date)})),
        ),
        actions: [
  ...
  Future<void> _deleteProspect(String id) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (dCtx) => AlertDialog(
        ...
        actions: [
          TextButton(onPressed: () => Navigator.pop(dCtx, false), child: Text('Annuler'.tr())),
          TextButton(
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            value: (report['role'] as String?) ?? _roles.first,
            items: _roles.map((r) => DropdownMenuItem(value: r, child: Text(r.tr()))).toList(),
            onChanged: (v) => setState(() => report['role'] = v ?? _roles.first),
          ),
          ...
          DropdownButtonFormField<String>(
            ...
            value: (report['status'] as String?) ?? 'vide',
            items: ['vide','présent','absent','rdv']
                .map((s) => DropdownMenuItem(value: s, child: Text(s.tr())))
                .toList(),
            onChanged: (v) => setState(() => report['status'] = v ?? 'vide'),
          ),
          const SizedBox(height: 8),
          ...
          TextFormField(
            ...
            onChanged: (t) => setState(() => report['phone'] = t),
          ),
          const SizedBox(height: 8),
          ...
          TextFormField(
            ...
            onChanged: (t) => setState(() => report['email'] = t),
          ),
          const SizedBox(height: 8),
          ...
          FilledButton.tonal(
            onPressed: () async {
              ...
              if (d1 != null) setState(() => report['nextVisit'] = d1);
            },
            child: Text(
          ...
          TextFormField(
            ...
            maxLines: 2,
            onChanged: (t) => setState(() => report['note'] = t),
          ),
          const SizedBox(height: 8),
          ...
          SwitchListTile.adaptive(
            ...
            value: (report['closed'] ?? false) as bool,
      ...
      child: BrandBackground(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                ...
                onPressed: _pickDate,
                tooltip: 'Changer la date'.tr(),
              ),
              IconButton(
                icon: const Icon(Icons.save_rounded),
                color: _allCompleted ? Colors.green : cs.onSurface.withOpacity(.4),
                tooltip: _allCompleted ? 'Enregistrer'.tr() : 'Compléter tous les prospects'.tr(),
          ...
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () async {
              final result = await Navigator.pushNamed(context, ProspectFormPage.routeName) as Prospect?;
              if (result != null) {
                setState(() {
                  _options.add(result);
                  _ensureReport(result.id);
                });
              }
            },
          ...
          body: Padding(
            ...
            child: _loading
                ...
                : _error != null
                ? Center(child: Text('Erreur : $_error')) // pas de .tr() dynamique
                : _options.isEmpty
                      ...
                      child: ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          value: _options.isNotEmpty
                              ? _reports.keys.where(_isComplete).length / _options.length
                              : 0,
                          color: cs.primary,
